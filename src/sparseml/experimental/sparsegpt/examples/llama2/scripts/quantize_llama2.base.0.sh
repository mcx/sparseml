...
RECIPE_DIR=/home/tuan/src/neuralmagic/sparseml/src/sparseml/experimental/sparsegpt/examples/llama2/recipes/llama-2-7b_base

DATASET=gsm8k

SRC_MODEL_DIR=/network/tuan/models/llama/GSM8K/base_finetuned
SRC_MODEL_NAME=llama-2-7b_base
