...
from sparseml.modifiers.experimental.incoh_sparsegpt.base import IncohSparseGPTModifier
from sparseml.modifiers.experimental.incoh_sparsegpt.utils.sgpt_wrapper import IncohSparseGptWrapper
from sparseml.modifiers.pruning.wanda.pytorch import WandaPruningModifierPyTorch


__all__ = ["IncohSparseGPTModifierPyTorch"]

_LOGGER = logging.getLogger(__name__)


class IncohSparseGPTModifierPyTorch(WandaPruningModifierPyTorch, IncohSparseGPTModifier):
    """
    ...
    def on_initialize(self, state: "State", **kwargs) -> bool:
        ...
        return super(IncohSparseGPTModifierPyTorch, self).on_initialize(state, **kwargs)
    ...
    def on_finalize(self, state: "State", **kwargs) -> bool:
        ...
        return super(IncohSparseGPTModifierPyTorch, self).on_finalize(state, **kwargs)
