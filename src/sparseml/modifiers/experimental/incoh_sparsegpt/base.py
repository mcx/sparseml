...
__all__ = ["IncohSparseGPTModifier"]

_LOGGER = logging.getLogger(__name__)


class IncohSparseGPTModifier(WandaPruningModifier):
    """
    Modifier for applying the one-shot OBCQ algorithm to a model, with incoherence processing
